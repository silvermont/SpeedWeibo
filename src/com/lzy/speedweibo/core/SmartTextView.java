...
public class SmartTextView extends TextView {
	...
	public void setMText(CharSequence cs) {
		...
		ArrayList<SpanObject> isList = new ArrayList<SmartTextView.SpanObject>();
		useDefault = false;
		if (cs instanceof SpannableString) {
			SpannableString ss = (SpannableString) cs;
			CharacterStyle[] spans = ss.getSpans(0, ss.length(),
